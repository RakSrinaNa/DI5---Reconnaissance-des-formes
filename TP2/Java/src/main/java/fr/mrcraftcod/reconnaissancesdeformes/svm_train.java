...
class svm_train{
	private static final Logger LOGGER = LoggerFactory.getLogger(svm_train.class);
	...
	private void do_cross_validation(){
		...
		if(param.svm_type == svm_parameter.EPSILON_SVR || param.svm_type == svm_parameter.NU_SVR){
			...
			LOGGER.debug("Cross Validation Mean squared error = " + total_error / prob.l + "\n");
			LOGGER.debug("Cross Validation Squared correlation coefficient = " + ((prob.l * sumvy - sumv * sumy) * (prob.l * sumvy - sumv * sumy)) / ((prob.l * sumvv - sumv * sumv) * (prob.l * sumyy - sumy * sumy)) + "\n");
		}
		else{
			for(i = 0; i < prob.l; i++){
			...
			LOGGER.debug("Cross Validation Accuracy = " + 100.0 * total_correct / prob.l + "%\n");
		}
	}
